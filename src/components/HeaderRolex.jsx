            ...
            <div className="hidden lg:flex items-center space-x-10">
              {navLinks.map((link) => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="text-[11px] tracking-[0.2em] text-white/80 hover:text-white transition-colors duration-300 font-light font-body"
                >
                  {link.name}
                </motion.button>
              ))}
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-2 text-[11px] tracking-[0.2em] text-white/80 hover:text-white transition-colors duration-300 font-light font-body group"
              >
                {/* Instagram icon */}
                <svg
                ...
                <div className="py-6 space-y-1">
                  {navLinks.map((link, index) => (
                    <motion.button
                      ...
                      onClick={() => scrollToSection(link.id)}
                      className="block w-full py-3 text-[11px] tracking-[0.2em] text-white/80 hover:text-white transition-colors text-left font-light font-body"
                    >
                      {link.name}
                    </motion.button>
                  ))}
                  ...
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 py-3 text-[11px] tracking-[0.2em] text-white/80 hover:text-white transition-colors font-light font-body"
                  >
